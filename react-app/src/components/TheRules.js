...
export default function TheRules() {
  ...
  return (
    <>
      ...
      <Typography className={classes.sentence} variant="body1">
        When the actual tournament starts, players are awarded points for their
        drafted teams winning games.
      </Typography>
      <Typography className={classes.sentence} variant="body1">
        You receive points for the seed number as well as the round number.
      </Typography>
      <Typography className={classes.sentence} variant="body1">
        If a 16 seed wins a first round game, the player that owns that team
        receives 16 + 0 = 16 points.
      </Typography>
      <Typography className={classes.sentence} variant="body1">
        If a 2 seed wins the championship, the player that owns that team
        receives 2 + 5 = 7 points.
      </Typography>
      <Typography className={classes.sentence} variant="body1">
        etc.
      </Typography>
