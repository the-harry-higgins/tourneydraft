...
export default function TheRules() {
  ...
  return (
    <>
      <Typography variant='h2' color='primary'>The Rules:</Typography>
      ...
      <Typography className={classes.sentence} variant='body1'>etc.</Typography>
      <Typography className={classes.sentence} variant='body1'>Most points is a partial winner.</Typography>
      <Typography className={classes.sentence} variant='body1'>Tournament champion is a partial winner.</Typography>
    </>
  );
}