...
def seed_2018_tournament():
    ...
    game_1 = Game(game_num=1, round_num=1, winning_team_id=uMBC.id, tournament_id=tournament.id)
    db.session.add(game_1)
    game_2 = Game(game_num=2, round_num=1, winning_team_id=kansas_State.id, tournament_id=tournament.id)
    db.session.add(game_2)
    game_3 = Game(game_num=3, round_num=1, winning_team_id=kentucky.id, tournament_id=tournament.id)
    db.session.add(game_3)
    game_4 = Game(game_num=4, round_num=1, winning_team_id=buffalo.id, tournament_id=tournament.id)
    db.session.add(game_4)
    game_5 = Game(game_num=5, round_num=1, winning_team_id=loyola_Chicago.id, tournament_id=tournament.id)
    db.session.add(game_5)
    game_6 = Game(game_num=6, round_num=1, winning_team_id=tennessee.id, tournament_id=tournament.id)
    db.session.add(game_6)
    game_7 = Game(game_num=7, round_num=1, winning_team_id=nevada.id, tournament_id=tournament.id)
    db.session.add(game_7)
    game_8 = Game(game_num=8, round_num=1, winning_team_id=cincinnati.id, tournament_id=tournament.id)
    db.session.add(game_8)
    game_9 = Game(game_num=9, round_num=1, winning_team_id=xavier.id, tournament_id=tournament.id)
    db.session.add(game_9)
    game_10 = Game(game_num=10, round_num=1, winning_team_id=florida_State.id, tournament_id=tournament.id)
    db.session.add(game_10)
    game_11 = Game(game_num=11, round_num=1, winning_team_id=ohio_State.id, tournament_id=tournament.id)
    db.session.add(game_11)
    game_12 = Game(game_num=12, round_num=1, winning_team_id=gonzaga.id, tournament_id=tournament.id)
    db.session.add(game_12)
    game_13 = Game(game_num=13, round_num=1, winning_team_id=houston.id, tournament_id=tournament.id)
    db.session.add(game_13)
    game_14 = Game(game_num=14, round_num=1, winning_team_id=michigan.id, tournament_id=tournament.id)
    db.session.add(game_14)
    game_15 = Game(game_num=15, round_num=1, winning_team_id=texas_AM.id, tournament_id=tournament.id)
    db.session.add(game_15)
    game_16 = Game(game_num=16, round_num=1, winning_team_id=north_Carolina.id, tournament_id=tournament.id)
    db.session.add(game_16)
    game_17 = Game(game_num=17, round_num=1, winning_team_id=villanova.id, tournament_id=tournament.id)
    db.session.add(game_17)
    game_18 = Game(game_num=18, round_num=1, winning_team_id=alabama.id, tournament_id=tournament.id)
    db.session.add(game_18)
    game_19 = Game(game_num=19, round_num=1, winning_team_id=west_Virginia.id, tournament_id=tournament.id)
    db.session.add(game_19)
    game_20 = Game(game_num=20, round_num=1, winning_team_id=marshall.id, tournament_id=tournament.id)
    db.session.add(game_20)
    game_21 = Game(game_num=21, round_num=1, winning_team_id=florida.id, tournament_id=tournament.id)
    db.session.add(game_21)
    game_22 = Game(game_num=22, round_num=1, winning_team_id=texas_Tech.id, tournament_id=tournament.id)
    db.session.add(game_22)
    game_23 = Game(game_num=23, round_num=1, winning_team_id=butler.id, tournament_id=tournament.id)
    db.session.add(game_23)
    game_24 = Game(game_num=24, round_num=1, winning_team_id=purdue.id, tournament_id=tournament.id)
    db.session.add(game_24)
    game_25 = Game(game_num=25, round_num=1, winning_team_id=kansas.id, tournament_id=tournament.id)
    db.session.add(game_25)
    game_26 = Game(game_num=26, round_num=1, winning_team_id=seton_Hall.id, tournament_id=tournament.id)
    db.session.add(game_26)
    game_27 = Game(game_num=27, round_num=1, winning_team_id=clemson.id, tournament_id=tournament.id)
    db.session.add(game_27)
    game_28 = Game(game_num=28, round_num=1, winning_team_id=auburn.id, tournament_id=tournament.id)
    db.session.add(game_28)
    game_29 = Game(game_num=29, round_num=1, winning_team_id=syracuse.id, tournament_id=tournament.id)
    db.session.add(game_29)
    game_30 = Game(game_num=30, round_num=1, winning_team_id=michigan_State.id, tournament_id=tournament.id)
    db.session.add(game_30)
    game_31 = Game(game_num=31, round_num=1, winning_team_id=rhode_Island.id, tournament_id=tournament.id)
    db.session.add(game_31)
    game_32 = Game(game_num=32, round_num=1, winning_team_id=duke.id, tournament_id=tournament.id)
    db.session.add(game_32)
    game_33 = Game(game_num=33, round_num=2, winning_team_id=kansas_State.id, tournament_id=tournament.id)
    db.session.add(game_33)
    game_34 = Game(game_num=34, round_num=2, winning_team_id=kentucky.id, tournament_id=tournament.id)
    db.session.add(game_34)
    game_35 = Game(game_num=35, round_num=2, winning_team_id=loyola_Chicago.id, tournament_id=tournament.id)
    db.session.add(game_35)
    game_36 = Game(game_num=36, round_num=2, winning_team_id=nevada.id, tournament_id=tournament.id)
    db.session.add(game_36)
    game_37 = Game(game_num=37, round_num=2, winning_team_id=florida_State.id, tournament_id=tournament.id)
    db.session.add(game_37)
    game_38 = Game(game_num=38, round_num=2, winning_team_id=gonzaga.id, tournament_id=tournament.id)
    db.session.add(game_38)
    game_39 = Game(game_num=39, round_num=2, winning_team_id=michigan.id, tournament_id=tournament.id)
    db.session.add(game_39)
    game_40 = Game(game_num=40, round_num=2, winning_team_id=texas_AM.id, tournament_id=tournament.id)
    db.session.add(game_40)
    game_41 = Game(game_num=41, round_num=2, winning_team_id=villanova.id, tournament_id=tournament.id)
    db.session.add(game_41)
    game_42 = Game(game_num=42, round_num=2, winning_team_id=west_Virginia.id, tournament_id=tournament.id)
    db.session.add(game_42)
    game_43 = Game(game_num=43, round_num=2, winning_team_id=texas_Tech.id, tournament_id=tournament.id)
    db.session.add(game_43)
    game_44 = Game(game_num=44, round_num=2, winning_team_id=purdue.id, tournament_id=tournament.id)
    db.session.add(game_44)
    game_45 = Game(game_num=45, round_num=2, winning_team_id=kansas.id, tournament_id=tournament.id)
    db.session.add(game_45)
    game_46 = Game(game_num=46, round_num=2, winning_team_id=clemson.id, tournament_id=tournament.id)
    db.session.add(game_46)
    game_47 = Game(game_num=47, round_num=2, winning_team_id=syracuse.id, tournament_id=tournament.id)
    db.session.add(game_47)
    game_48 = Game(game_num=48, round_num=2, winning_team_id=duke.id, tournament_id=tournament.id)
    db.session.add(game_48)
    game_49 = Game(game_num=49, round_num=3, winning_team_id=kansas_State.id, tournament_id=tournament.id)
    db.session.add(game_49)
    game_50 = Game(game_num=50, round_num=3, winning_team_id=loyola_Chicago.id, tournament_id=tournament.id)
    db.session.add(game_50)
    game_51 = Game(game_num=51, round_num=3, winning_team_id=florida_State.id, tournament_id=tournament.id)
    db.session.add(game_51)
    game_52 = Game(game_num=52, round_num=3, winning_team_id=michigan.id, tournament_id=tournament.id)
    db.session.add(game_52)
    game_53 = Game(game_num=53, round_num=3, winning_team_id=villanova.id, tournament_id=tournament.id)
    db.session.add(game_53)
    game_54 = Game(game_num=54, round_num=3, winning_team_id=texas_Tech.id, tournament_id=tournament.id)
    db.session.add(game_54)
    game_55 = Game(game_num=55, round_num=3, winning_team_id=kansas.id, tournament_id=tournament.id)
    db.session.add(game_55)
    game_56 = Game(game_num=56, round_num=3, winning_team_id=duke.id, tournament_id=tournament.id)
    db.session.add(game_56)
    game_57 = Game(game_num=57, round_num=4, winning_team_id=loyola_Chicago.id, tournament_id=tournament.id)
    db.session.add(game_57)
    game_58 = Game(game_num=58, round_num=4, winning_team_id=michigan.id, tournament_id=tournament.id)
    db.session.add(game_58)
    game_59 = Game(game_num=59, round_num=4, winning_team_id=villanova.id, tournament_id=tournament.id)
    db.session.add(game_59)
    game_60 = Game(game_num=60, round_num=4, winning_team_id=kansas.id, tournament_id=tournament.id)
    db.session.add(game_60)
    game_61 = Game(game_num=61, round_num=5, winning_team_id=michigan.id, tournament_id=tournament.id)
    db.session.add(game_61)
    game_62 = Game(game_num=62, round_num=5, winning_team_id=villanova.id, tournament_id=tournament.id)
    db.session.add(game_62)
    game_63 = Game(game_num=63, round_num=6, winning_team_id=villanova.id, tournament_id=tournament.id)
