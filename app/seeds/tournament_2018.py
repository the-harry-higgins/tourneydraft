...
def seed_2018_tournament():
    ...
    game_2 = Game(game_num=2, round_num=1, winning_team_id=kansas_State.id)
    db.session.add(game_2)
    game_3 = Game(game_num=3, round_num=1, winning_team_id=kentucky.id)
    db.session.add(game_3)
    game_4 = Game(game_num=4, round_num=1, winning_team_id=buffalo.id)
    db.session.add(game_4)
    game_5 = Game(game_num=5, round_num=1, winning_team_id=loyola_Chicago.id)
    db.session.add(game_5)
    game_6 = Game(game_num=6, round_num=1, winning_team_id=tennessee.id)
    db.session.add(game_6)
    game_7 = Game(game_num=7, round_num=1, winning_team_id=nevada.id)
    db.session.add(game_7)
    game_8 = Game(game_num=8, round_num=1, winning_team_id=cincinnati.id)
    db.session.add(game_8)
    game_9 = Game(game_num=9, round_num=1, winning_team_id=xavier.id)
    db.session.add(game_9)
    game_10 = Game(game_num=10, round_num=1, winning_team_id=florida_State.id)
    db.session.add(game_10)
    game_11 = Game(game_num=11, round_num=1, winning_team_id=ohio_State.id)
    db.session.add(game_11)
    game_12 = Game(game_num=12, round_num=1, winning_team_id=gonzaga.id)
    db.session.add(game_12)
    game_13 = Game(game_num=13, round_num=1, winning_team_id=houston.id)
    db.session.add(game_13)
    game_14 = Game(game_num=14, round_num=1, winning_team_id=michigan.id)
    db.session.add(game_14)
    game_15 = Game(game_num=15, round_num=1, winning_team_id=texas_AM.id)
    db.session.add(game_15)
    game_16 = Game(game_num=16, round_num=1, winning_team_id=north_Carolina.id)
    db.session.add(game_16)
    game_17 = Game(game_num=17, round_num=1, winning_team_id=villanova.id)
    db.session.add(game_17)
    game_18 = Game(game_num=18, round_num=1, winning_team_id=alabama.id)
    db.session.add(game_18)
    game_19 = Game(game_num=19, round_num=1, winning_team_id=west_Virginia.id)
    db.session.add(game_19)
    game_20 = Game(game_num=20, round_num=1, winning_team_id=marshall.id)
    db.session.add(game_20)
    game_21 = Game(game_num=21, round_num=1, winning_team_id=florida.id)
    db.session.add(game_21)
    game_22 = Game(game_num=22, round_num=1, winning_team_id=texas_Tech.id)
    db.session.add(game_22)
    game_23 = Game(game_num=23, round_num=1, winning_team_id=butler.id)
    db.session.add(game_23)
    game_24 = Game(game_num=24, round_num=1, winning_team_id=purdue.id)
    db.session.add(game_24)
    game_25 = Game(game_num=25, round_num=1, winning_team_id=kansas.id)
    db.session.add(game_25)
    game_26 = Game(game_num=26, round_num=1, winning_team_id=seton_Hall.id)
    db.session.add(game_26)
    game_27 = Game(game_num=27, round_num=1, winning_team_id=clemson.id)
    db.session.add(game_27)
    game_28 = Game(game_num=28, round_num=1, winning_team_id=auburn.id)
    db.session.add(game_28)
    game_29 = Game(game_num=29, round_num=1, winning_team_id=syracuse.id)
    db.session.add(game_29)
    game_30 = Game(game_num=30, round_num=1, winning_team_id=michigan_State.id)
    db.session.add(game_30)
    game_31 = Game(game_num=31, round_num=1, winning_team_id=rhode_Island.id)
    db.session.add(game_31)
    game_32 = Game(game_num=32, round_num=1, winning_team_id=duke.id)
